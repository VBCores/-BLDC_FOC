...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
extern uint16_t encoder_raw_angle;

extern uint32_t SPI3_CS_PIN;
extern GPIO_TypeDef * SPI3_CS_PORT;
...
void SPI3_IRQHandler(void)
{
  ...
  if (LL_SPI_IsActiveFlag_RXNE(SPI3))
  {
    ...
    // check parity of received message in case data from encoder seems to be corrupted
    if( (RX >> 14) & 1u )
    {
      //Error_Handler();
    }
